...
async def get_mcp_server_info():
    ...
    return {
        ...
        "tools": [
            "spawn_agent", "check_agent_status", "execute_purpose_endpoint", 
            "list_purpose_endpoints", "get_agent_capabilities", "list_active_agents", 
            "cancel_agent", "create_workflow_template"
        ]
    }
